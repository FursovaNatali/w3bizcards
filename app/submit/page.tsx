      ...
      <main className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-10 max-w-md w-full text-center">
          ...
          <p className="text-slate-500">
            Thank you! Your company card has been submitted. The admin will
            review it shortly and you will appear in the directory once
            approved.
          </p>
          <a
            href="/"
      ...
      <div className="max-w-xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-slate-900 mt-3">
            Submit Your company Card
          </h1>
          <p className="text-slate-500 mt-2">
            Fill in your details below. Your card will be reviewed before
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {[
              ...
              <div
                key={key}
                className={key === "website" ? "sm:col-span-2" : ""}
              >
